...
\begin{longtable}{| >{\raggedright}m{0.12\textwidth}
...
\end{equation}
\begin{explanation}
где $\text{К}_{i}$ -- \text{коэффициент, соответствующий степени повышения сложности ПО за счет конкретной характеристики;} \\
