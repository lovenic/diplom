...
\FPround{\taxWorkProtCost}{\taxWorkProtCostExact}{2}
...
\FPround{\localRepubTax}{\localRepubTaxExact}{1}
...
Вычисленные оценки показывают, что для выполнения запланированного проекта в указанные сроки необходимо трое рабочих.
...
\begin{longtable}{| >{\raggedright}m{0.5\textwidth}
                  | >{\centering}m{0.15\textwidth}
...
\begin{longtable}{| >{\raggedright}m{0.20\textwidth}
